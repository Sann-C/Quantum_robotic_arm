...
#
get_filename_component(filename "/home/sann/ros_ws/Open3D/3rdparty_downloads/pybind11/v2.13.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/sann/ros_ws/build/Open3D/_deps/ext_pybind11-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-ext_pybind11-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-ext_pybind11-populate${i}")
